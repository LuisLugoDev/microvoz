...
<template>
    ...
    >
        ...
        <div class="max-w-6xl mx-auto sm:px-6 lg:px-8">
         ...
         <h2 class="font-semibold text-xl text-gray-800 leading-tight">PRUEBA CRUD - Microvoz</h2>
         <p> por favor utilize la opcion registrar para comenzar.</p>
         <p> Nota: debe haber corrido primero el comando <pre>php artisan migrate</pre>.</p>
         <p> Luego el comando <pre>php artisan db:seed</pre>.</p>
